package edu.gatech.uweather.service;
...
import edu.gatech.uweather.BuildConfig;
...
public class Service extends IntentService {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            locationId = locationCursor.getColumnIndex(WeatherContract.LocationEntry._ID);
        } else {
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            sendIntent.putExtra(Service.LOCATION_QUERY_EXTRA,intent.getStringExtra(Service.LOCATION_QUERY_EXTRA));
